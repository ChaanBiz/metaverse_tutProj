    ...
    <motion.div
      ...
      >
        <div className="absolute w-full h-[300px] hero-gradient rounded-tl-[140px] z-[0] -top-[30px]"/>
          ...
          <a href="#explore">
            <div className="w-full flex justify-end sm:m=-mt-[70px] -mt-[50px] pr-[40]x relative z-10">
              <img src="/stamp.png" alt="stamp" className="sm:w-[115px] w-[100px] sm:h-[155px] h-[100px] object-contain"/>
            </div>
          </a>
      </motion.div>
